...
* <field name="product"
* 	type="foreignkey"
* 	label="COM_FEEDBACK_FORM_LBL_ORDER_PRODUCT"
* 	description="COM_FEEDBACK_FORM_DESC_ORDER_PRODUCT"
* 	class="inputbox"
* 	input_type="list"
* 	table="#__content"
* 	key_field="id"
* 	value_multiple="1"
* 	value_field="val"
* 	value_field_multiple="title,language"
* 	required="true"
* 	where="state=1 AND catid > 0"
* 	multiple="true"
* 	default=""/>
*/
...
class JFormFieldForeignKey extends JFormField
{
	...
	protected function getInput()
	{
		...
		$this->where = (string) $this->getAttribute('where');
